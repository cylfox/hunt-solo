...
local STRINGS = {
    ...
    is_advisor_target_skipped = {
        [LANG.ENG] = 'Stop handler from following you',
        [LANG.SPA] = 'Evitar que el encargado te siga',
        [LANG.JAP] = 'ハンドラーの追従を止める',
        [LANG.CHI] = '阻止随从官跟随你',
    },
    is_advisor_target_skipped_in_camp_areas = {
        [LANG.ENG] = 'Stop handler from following you in camp areas (caution)',
        [LANG.SPA] = 'Evitar que el encargado te siga en campamentos (cuidado)',
        [LANG.JAP] = 'キャンプエリアでハンドラーの追従を止める（注意）',
        [LANG.CHI] = '在营地区域阻止随从官跟随你（注意）',
    },
    is_npc_support_hunters_target_skipped = {
        [LANG.ENG] = 'Stop NPC Support Hunters from helping you',
        [LANG.SPA] = 'Evitar que los Cazadores de apoyo (NPC) te ayuden',
        [LANG.JAP] = 'NPCサポートハンターのサポートを止める',
        [LANG.CHI] = '阻止NPC支援猎人协助你',
    },
    is_npc_support_hunters_target_skipped_in_mainstory = {
        [LANG.ENG] = 'Stop NPC Support Hunters from helping you in main story quests (caution)',
        [LANG.SPA] = 'Evitar que los Cazadores de apoyo (NPC) te ayuden en misiones principales (cuidado)',
        [LANG.JAP] = 'メインクエストでNPCサポートハンターのサポートを止める（注意）',
        [LANG.CHI] = '在主线任务中阻止NPC支援猎人协助你（注意）',
    },
    is_standby_otomo_behavior_blocked = {
        [LANG.ENG] = 'Stop Palico from following you (Only if palico is in standby mode)',
        [LANG.SPA] = 'Evitar que el Palico te siga (Solo si está en modo espera)',
        [LANG.JAP] = '待機中のアイルーの追従を止める（スタンバイ時のみ）',
        [LANG.CHI] = '阻止随从猫跟随你（仅待命模式）',
    },
    is_standby_otomo_behavior_blocked_in_camp_areas = {
        [LANG.ENG] = 'Stop Palico from following you in camp areas (caution)',
        [LANG.SPA] = 'Evitar que el Palico te siga en campamentos (cuidado)',
        [LANG.JAP] = 'キャンプエリアでアイルーの追従を止める（注意）',
        [LANG.CHI] = '在营地区域阻止随从猫跟随你（注意）',
    },
    ...
    show_json_dump_window = {
        [LANG.ENG] = 'Show variables window',
        [LANG.SPA] = 'Mostrar ventana de variables',
        [LANG.JAP] = '変数ウィンドウを表示',
        [LANG.CHI] = '显示变量窗口',
    },
}
